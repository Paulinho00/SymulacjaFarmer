...
/**
 *  zwierze rodzaju "Krowa" ktore porusza sie po planszy
 */
public class Krowa implements postac.Postac{
     ...
     */
    public Krowa(int x, int y, Plansza plansza){
        koordynatX = x;
        koordynatY = y;
    ...
    /**
     * ustawia nowa wartosc pola {@link Krowa#wykonalRuch}
     * @param wykonalRuch nowa wartosc pola {@link Krowa#wykonalRuch}
     */
